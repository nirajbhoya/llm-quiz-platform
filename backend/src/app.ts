...
import doubtSessionRoutes from './modules/doubts/doubt-sessions.routes';
import communityDoubtRoutes from './modules/doubts/community-doubts.routes';
...
export const createApp = () => {
  ...
  app.use('/api/doubt-sessions', doubtSessionRoutes);
  app.use('/api/community-doubts', communityDoubtRoutes);
